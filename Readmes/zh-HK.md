...
> [!CAUTION]
> **安全警告：請僅從官方來源下載 Lertaro。** 為確保安全，請僅從官方倉庫、官方網站和 [GitHub Releases](https://github.com/Lertaro/Lertaro/releases) 下載 Lertaro。請勿下載或執行來自未經驗證的來源或倉庫的檔案。
...
📖 **[完整文檔、使用者手冊與開發手冊](https://lertaro.github.io/zh-HK/)**
...
搜尋語法、每一個快速鍵、每一項設定詳見[使用者手冊](https://lertaro.github.io/zh-HK/user-guide/)；架構設計與外掛 SDK 參考詳見[開發手冊](https://lertaro.github.io/zh-HK/dev-guide/)。

## 下載

在[專案首頁](https://lertaro.github.io/zh-HK/)獲取最新版本，或直接下載：
...
環境要求：Windows 10/11、.NET 10 SDK、Visual Studio 2022 或 JetBrains Rider；如需產生安裝套件還需要 [64 位元 Inno Setup 7](https://jrsoftware.org/isdl.php#v7)。

- `build_and_run.bat` —— 重新編譯 App/Core/Service/外掛並在本機重新啟動，適合日常開發除錯。
- `make.bat` —— 產生 Release 建構，產出 `dist/` 目錄下的 x64 與 ARM64 安裝套件及便攜包。

完整架構設計與外掛 SDK 詳見[開發手冊](https://lertaro.github.io/zh-HK/dev-guide/)。
