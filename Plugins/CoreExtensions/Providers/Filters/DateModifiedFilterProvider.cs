...
public class DateModifiedFilterProvider : ISidebarFilterProvider
{
    ...
    public IEnumerable<SidebarFilterGroup> GetFilterGroups()
    {
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            MatchPredicate = BuildDatePredicate(1)
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            MatchPredicate = BuildDatePredicate(7)
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            IconData = "M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2z",
            MatchPredicate = BuildDatePredicate(30)
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            MatchPredicate = BuildDatePredicate(365)
        });
    ...
    private static Func<ISearchResult, bool> BuildDatePredicate(int days)
    {
        var cutoff = DateTime.Now.AddDays(-days);
        return result => result.Metadata.Modified != DateTime.MinValue && result.Metadata.Modified >= cutoff;
    }
}
