...
public class FileSizeFilterProvider : ISidebarFilterProvider
{
    ...
    public IEnumerable<SidebarFilterGroup> GetFilterGroups()
    {
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            MatchPredicate = result => MatchesSize(result, size => size < 1 * 1024 * 1024)
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            MatchPredicate = result => MatchesSize(result, size => size >= 1 * 1024 * 1024 && size <= 100 * 1024 * 1024)
        });
        ...
        group.Items.Add(new SidebarFilterItem
        {
            ...
            MatchPredicate = result => MatchesSize(result, size => size > 100 * 1024 * 1024)
        });
    ...
    private static bool MatchesSize(ISearchResult result, Func<long, bool> matches) =>
        !result.IsDir && result.Metadata.Modified != DateTime.MinValue && matches(result.Metadata.Size);
}
