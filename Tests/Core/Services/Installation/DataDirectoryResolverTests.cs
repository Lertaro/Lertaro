...
{
    [TestMethod]
    public void ResolveShared_PortableCopyKeepsMachineDataBesideTheApplication() => Assert.AreEqual(
    ...
    [TestMethod]
    public void ResolveUser_PortableCopyKeepsUserDataUnderTheSidHash() => Assert.AreEqual(
