...
- Con el panel visible, usa las flechas para mover la selección según la cuadrícula visual: **←** y **→** atraviesan los límites de las filas, mientras **↑** y **↓** conservan la columna actual. Si la última fila no tiene un elemento en esa columna, el movimiento vertical se detiene y la selección no vuelve al principio ni al final.
