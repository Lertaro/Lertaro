...
- **Gestión y configuración de plugins**: Escribe la palabra clave `flow` en la barra de búsqueda para listar todos los plugins de Flow Launcher cargados junto con sus palabras clave de activación y estado. Al seleccionar cualquier plugin configurable y pulsar **Enter**, se abrirá su ventana de configuración dedicada, con protección de guardado por confirmación y reversión al cancelar.
