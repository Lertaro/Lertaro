...
- La lista de la derecha muestra los mismos elementos ordenados por tamaño descendente. Seleccionar un elemento en una vista también lo resalta en la otra.
...
Solo se incluyen los elementos que ya existen en los índices habilitados de Lertaro, y el analizador nunca recorre el sistema de archivos para completar lo que falta. El contenido excluido o no indexado está ausente; los elementos ocultos y del sistema no se muestran individualmente, aunque su tamaño todavía puede contribuir al total de una carpeta antecesora visible.
...
Al abrir la ventana o pulsar **Actualizar** se consulta el estado más reciente de los índices en memoria, incluidos los cambios de archivos que ya hayan recibido los monitores activos. El analizador no abre ni vuelve a cargar por separado los archivos de caché del índice. Al cerrar la ventana se liberan los elementos renderizados y las cachés de interfaz compartidas.
